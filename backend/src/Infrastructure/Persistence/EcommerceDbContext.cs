...
/// <summary>
/// Lleva un control de las auditoría de las tablas quien agrega, quien modifica
/// </summary>
...
/// <returns></returns>
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Category>()
            ...
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict); //si eliminas una categoria no se van a eliminar los productos
        ...
        builder.Entity<Product>()
            ...
            .IsRequired()
            .OnDelete(DeleteBehavior.Cascade); //Si elimino el producto, va a eliminar todos los review relacionados al producto
        ...
        builder.Entity<Product>()
            ...
            .HasForeignKey(r => r.ProductId)
            .IsRequired()
            .OnDelete(DeleteBehavior.Cascade); //si eliminamos un producto,e ste va a eliminar las imagenes relacionadas al producto
